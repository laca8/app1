...
const UpdatePlayer = ({ show, setShow }) => {
  ...
  const updatePlayerRed = useSelector((state) => state.updatePlayerRed);
  const { success, loading, error } = updatePlayerRed;
